...
public class GazetteSupervisorTuningConfig extends GazetteIndexTaskTuningConfig
    implements SeekableStreamSupervisorTuningConfig
{
  ...
  public static GazetteSupervisorTuningConfig defaultConfig()
  {
    return new GazetteSupervisorTuningConfig(
        null,
        null,
        null,
        null,
  ...
  public GazetteSupervisorTuningConfig(
  ...
  {
    // Stopping tasks early for Gazette ingestion on journal set change is not supported yet,
  ...
  {
    return "GazetteSupervisorTuningConfig{" +
  ...
  @Override
  public GazetteIndexTaskTuningConfig convertToTaskTuningConfig()
  {
    return new GazetteIndexTaskTuningConfig(
        getMaxRowsInMemory(),
        getMaxBytesInMemory(),
