...
public class GazetteIndexTaskTuningConfig extends SeekableStreamIndexTaskTuningConfig
{
  @JsonCreator
  public GazetteIndexTaskTuningConfig(
  ...
  @Override
  public GazetteIndexTaskTuningConfig withBasePersistDirectory(File dir)
  {
  ...
  {
    return "GazetteIndexTaskTuningConfig{" +
